  ...
  return (
    <div>
      <div
        ...
        <div className="flex py-1 flex-grow items-center justify-left bg-[#a8b1ff] text-center px-4 bg-opacity-40 ">
          <GrDocumentText
            size={47}
            className="flex flex-shrink-0 lg:flex opacity-[95%] h-[44px] pr-4"
          />
          <div className="flex flex-col my-1">
            <h1 className="text-left text-sm lg:text-md font-light">{topic.title || "Cleanup Helpers"}</h1>
            <div className="flex pt-3 sm:pt-2 md:pt-2 items-center justify-left text-center bg-opacity-40 w-full lg:pr-7 text-xs lg:text-md pr-[0px]">Started By User: {topic.user_id ? topic.user_id.slice(17) : "Unknown User"}</div>
          </div>
        </div>
        <div className="flex flex-row ">
          <div className="flex py-1 items-center justify-center bg-[#a8b1ff] text-center px-2 md:px-4 bg-opacity-40 w-full lg:pr-7 text-xs lg:text-base pr-[30px]">{postCount !== null ? postCount : "Loading..."}</div>
          <div className="flex py-1 items-center justify-center bg-[#a8b1ff] text-center px-2 md:px-4 bg-opacity-40 w-full text-xs lg:text-base pr-[40px]">{viewCount !== null ? viewCount : "Loading..."}</div>
          <div className="flex flex-col py-1 rounded-t-none items-center justify-center bg-[#a8b1ff] text-center px-1 md:px-4 bg-opacity-40 lg:whitespace-nowrap w-full text-xs lg:text-base">
