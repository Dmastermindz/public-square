            ...
            <div className="flex h-1/4 lg:h-1/2 mb-6 w-full py-5 text-text-primary overflow-x-scroll bg-accent-purple bg-opacity-20 rounded-xl">
              <div>
                <h2 className="text-md pl-8 font-light mb-2 text-text-primary">
                  By: <span className="text-accent-purple font-semibold text-md">&nbsp;{selectedPost?.user_id}</span>
                </h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <textarea
                ...
                className="w-full h-[250px] lg:h-[175px] text-base px-3 py-2 rounded-md bg-accent-purple bg-opacity-20 text-text-primary border border-accent-purple border-opacity-30 focus:border-accent-purple focus:outline-none"
                rows="2"
                required></textarea>
            </div>
